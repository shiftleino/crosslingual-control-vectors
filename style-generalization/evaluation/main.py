...
def main(generations_file_path: str, baseline_file_path: str, result_folder_path: str, comparison_prompt_path: str, model_name: str, api_key: str, language: str, finnish_questions_path: str):
    ...
    results = evaluate_model_generations(answers, baselines, comparison_prompt_path, model_name, client, language, finnish_questions_path)
...
if __name__ == "__main__":
    ...
    main(generation_file_path, baseline_file_path, result_folder_path, comparison_prompt_path, model_name, api_key, language, finnish_questions_path)
