...
def evaluate_model_generations(answers: List[str], baselines: List[str], comparison_prompt_path: str, model_name: str, client, language: str, finnish_questions_path: str):
